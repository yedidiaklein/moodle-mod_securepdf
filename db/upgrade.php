...
function xmldb_securepdf_upgrade($oldversion) {
    ...
    if ($oldversion < 2013071701) {
        ...
        upgrade_mod_savepoint(true, 2013071701, 'securepdf');
    }
    ...
    if ($oldversion < 2013092200) {
        ...
        /* Once we reach this point, we can store the new version and
           ...
           next time this block is skipped. */
        upgrade_mod_savepoint(true, 2013092200, 'securepdf');
    }
    ...
    if ($oldversion < 2017060404) {
        ...
        // Adding fields to table securepdfbookmarks.
        ...
        // Adding keys to table securepdfbookmarks.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Conditionally launch create table for securepdfbookmarks.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }

        // Securepdf savepoint reached.
        upgrade_mod_savepoint(true, 2017060404, 'securepdf');
    }

    if ($oldversion < 2017060405) {

        // Define field moduleid to be added to securepdfbookmarks.
        $table = new xmldb_table('securepdfbookmarks');
        ...
        // Securepdf savepoint reached.
        upgrade_mod_savepoint(true, 2017060405, 'securepdf');
    }
